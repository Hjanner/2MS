...
inventarios_controller = BaseController[Inventario](inventario_service)
detalle_venta_controller = BaseController[DetalleVenta](detalle_venta_service)
compra_inventario_controller = BaseController[CompraInventario](compra_inventario_service)
